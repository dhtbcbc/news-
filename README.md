...
<head>
    ...
    <style>
        ...
        .hero-section {
            padding: 5rem 1rem;
            text-align: center;
            background: linear-gradient(rgba(255, 242, 224, 0.9), rgba(255, 242, 224, 0.9)), url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 100 100"><rect width="100" height="100" fill="%23FFA500" opacity="0.1"/><path d="M20,20 L80,80 M80,20 L20,80" stroke="%238B5E3C" stroke-width="0.5" stroke-opacity="0.3"/></svg>');
...
<body>
    ...
    <main class="container mx-auto px-4">
        ...
        <section id="poets-section" class="content-section py-10 sm:py-16">
            <h2 class="text-4xl font-bold text-dark-heading text-center mb-10">الشعراء العراقيون</h2>
    ...
    <script>
        ...
        const poetsData = [
            ...
            {
                id: 'muzaffar_al_nawab',
                name: 'مظفر النواب',
                bio: 'شاعر عراقي معاصر، ولد في بغداد عام 1934 وتوفي في الإمارات عام 2022. عُرف بشعره الثوري والسياسي الجريء، وكان من أشد المعارضين للأنظمة الديكتاتورية في الوطن العربي. تميز شعره باللهجة العامية العراقية مع صبغة فصحى قوية، وتميزت قصائده بالقوة والجرأة والعاطفة الجياشة.',
                poems: {
                    wisdom: [
                        { title: 'القدس عروس عروبتنا', text: 'القدسُ عروسُ عروبتنا\nوالدمعُ منها على الخدينِ يجري\nوالقيدُ في أعناقنا ثقيلٌ\nولكننا سنكسرُهُ غداً بيمينِ' }
                    ],
                    separation: [
                        { title: 'قراءة في دفتر المطر', text: 'مطرٌ.. مطرٌ..\nوالأرضُ تبكي تحتَ وقعِ الخيباتِ\nوالروحُ تبحثُ عن ملاذٍ\nفي زمنٍ فقدَ الإنسانيَّاتِ' }
                    ]
                }
            },
            {
                id: 'blund_al_heydari',
                name: 'بلند الحيدري',
                bio: 'شاعر عراقي من مواليد كركوك عام 1926 وتوفي في لندن عام 1996. يُعد من رواد الشعر الحديث في العراق، أسهم في تطوير القصيدة العربية من خلال تجاربه الشعرية المتميزة. تميز شعره بالرمزية والعمق الفلسفي، وتناول مواضيع الوجود والموت والحب والمنفى.',
                poems: {
                    love: [
                        { title: 'رسالة إلى حبيبتي', text: 'في الليلِ الطويلِ، أرسلُ همساتي\nلحبيبتي التي في القلبِ تسكنُ\nأقولُ: الحبُّ بحرٌ لا شطآنَ له\nوأنا الغريقُ الذي في أعماقهِ يغرقُ' }
                    ],
                    longing: [
                        { title: 'أغنية المطر', text: 'تمطرُ السماءُ دموعاً\nعلى أطلالِ ذكرياتٍ مضتْ\nويعزفُ الريحُ لحناً\nعن وطنٍ في القلبِ ما زالَ حياً' }
                    ]
                }
            },
            {
                ...
                bio: 'شاعرة عراقية ولدت في بغداد عام 1929 وتوفيت عام 2021. تُعد من أهم الشاعرات العراقيات في القرن العشرين، تميز شعرها بالرومانسية والعاطفة الجياشة والعمق الإنساني. عُرفت بقصائدها الغزلية العميقة التي تعكس مشاعر المرأة وتجاربها في الحب والحياة.',
                poems: {
                    love: [
                        { title: 'أحبك أكثر', text: 'أحبكِ أكثرَ مما تتصورين\nحباً يذيبُ الجليدَ في قلبي\nحباً يضيءُ ظلامَ ليالينا\nحباً يملأُ الكونَ سحراً وطربا' }
                    ],
                    ghazal: [
                        { title: 'يا حبيبي', text: 'يا حبيبي، متى تعودُ؟\nقد طالَ الانتظارُ، وطالَ البعادُ\nالقلبُ يشتاقُ، والعينُ تذرفُ\nوالروحُ تحترقُ من شدةِ الصدودِ\nعدْ، فبدونكَ الحياةُ ظلامٌ\nوالأيامُ بلا معنى أو وجودِ' }
                    ]
                }
            }
        ];
